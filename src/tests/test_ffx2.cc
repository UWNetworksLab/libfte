...
TEST(FFX2, TestVector3) {
    fte::ffx2 ffxObj = fte::ffx2::ffx2();
    std::string K = "\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF";
    mpz_class X = 1191613746;
    uint32_t X_len = 32;
    mpz_class Y = ffxObj.encrypt(K, X, X_len);
...
TEST(FFX2, TestVector5) {
    fte::ffx2 ffxObj = fte::ffx2::ffx2();
    std::string K = "\x00\x00\x00\x00\x00\x00\x00\x00\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF"; //doesn't
    mpz_class X = 1191613746;
    uint32_t X_len = 32;
    mpz_class Y = ffxObj.encrypt(K, X, X_len);
    EXPECT_EQ( Y, 1893931334 );
}

TEST(FFX2, TestVector6) {
    fte::ffx2 ffxObj = fte::ffx2::ffx2();
    std::string K = "\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x00\x00\x00\x00\x00\x00\x00\x00"; //works
    mpz_class X = 1546594394;
    uint32_t X_len = 32;
    mpz_class Y = ffxObj.encrypt(K, X, X_len);
    EXPECT_EQ( Y, 3075264695 );
}

TEST(FFX2Malicous, LongKey1) {
    fte::ffx2 ffxObj = fte::ffx2::ffx2();
    std::string K = "";
    mpz_class X = 1191613746;
    uint32_t X_len = 32;
    uint32_t Y_len = 32;
    mpz_class Y = ffxObj.encrypt(K, X, X_len);
