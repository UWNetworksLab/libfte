...
#define LOG_INFO RE2RE2RE2RE2RE2RE2LogMessage(__FILE__, __LINE__)
...
class RE2RE2RE2RE2RE2RE2LogMessage {
 public:
  RE2RE2RE2RE2RE2RE2LogMessage(const char* file, int line) : flushed_(false) {
    stream() << file << ":" << line << ": ";
  }
  void Flush() {
    stream() << "\n";
 ...
 private:
  ...
  DISALLOW_EVIL_CONSTRUCTORS(RE2RE2RE2RE2RE2RE2LogMessage);
};

class RE2RE2LogMessageFatal : public RE2RE2RE2RE2RE2RE2LogMessage {
 public:
  RE2RE2LogMessageFatal(const char* file, int line)
    : RE2RE2RE2RE2RE2RE2LogMessage(file, line) { }
